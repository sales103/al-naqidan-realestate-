...
import { listClients, getClient, createClient, updateClient, getClientStats, addClientNote, getClientMatches } from '../controllers/client.controller.js';
...
router.get('/:id/matches', getClientMatches);
